...
<script type="text/javascript">
	...
	$(function(){
		$("#next1").click(function(){
			...
			var username = $("#username-input").val(), divusername = $("#div-username"), inputusername = $("#span-username");
			var name = $("#name").val(), divname = $("#div-name"), inputname = $("#span-name");
			var surname = $("#surname").val(), divsurname = $("#div-surname"), inputsurname = $("#span-surname");
			var birthdate = $("#birthDate").val(), divbirthdate = $("#div-birthdate"), inputbirthdate = $("#span-birthdate");
			var dni = $("#dni").val(), divdni = $("#div-dni"), inputdni = $("#span-dni");
			var letra = dni.substring(8, 9);
			var numero = dni.substring(0,8);
			var email1 = $("#email").val(), divemail1 = $("#div-email1"), inputemail1 = $("#span-email1");
			var email2 = $("#confirmMail").val(), divemail2 = $("#div-email2"), inputemail2 = $("#span-email2");
			var pass1 = $("#pass").val(), divpass1 = $("#div-pass1"), inputpass1 = $("#span-pass1");
			var pass2 = $("#confirmPass").val(), divpass2 = $("#div-pass2"), inputpass2 = $("#span-pass2");
			
			var modulo = numero%23;
			// Fallo en el username
			if(username.length > 3){
				$.post("user/checkUsername.do?username="+username, function(result){
					if(result == 1){
						divusername.attr('class', 'form-group has-success has-feedback');
						inputusername.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
					}else{
						divusername.attr('class', 'form-group has-error has-feedback');
						inputusername.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
						$("#username-input").tooltip({
							placement : 'auto-right',
							title : '<spring:message code="security.register.usernameerror" />'
						});
						error = true;
					}
				});
			...
			// Fallo en el nombre
			if(name == "" || name == null){
				divname.attr('class', 'form-group has-error has-feedback');
				inputname.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				$("#name").tooltip({
					placement : 'auto-right',
					title : '<spring:message code="security.register.nameerror" />'
				});
				error = true;
			}else{
				divname.attr('class', 'form-group has-success has-feedback');
				inputname.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
			}
			// Fallo en el apellido
			if(surname == "" || surname == null){
				divsurname.attr('class', 'form-group has-error has-feedback');
				inputsurname.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				$("#surname").tooltip({
					placement : 'auto-right',
					title : '<spring:message code="security.register.surnameerror" />'
				});
				error = true;
			}else{
				divsurname.attr('class', 'form-group has-success has-feedback');
				inputsurname.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
			}
			// Fallo en el birthdate
			if(birthdate == "" || birthdate == null){
				divbirthdate.attr('class', 'form-group has-error has-feedback');
				inputbirthdate.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				$("#birthDate").tooltip({
					placement : 'auto-right',
					title : '<spring:message code="security.register.birthdateerror" />'
				});
				error = true;
			}else{
				divbirthdate.attr('class', 'form-group has-success has-feedback');
				inputbirthdate.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
			}
			// Fallo en el dni
			if(letra != tabla[modulo]){
				divdni.attr('class', 'form-group has-error has-feedback');
				inputdni.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				$("#dni").tooltip({
					placement : 'auto-right',
					title : '<spring:message code="security.register.dnierror" />'
				});
				error = true;
			}else{
				divdni.attr('class', 'form-group has-success has-feedback');
				inputdni.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
			}
			// Fallo en el email
			if(expresionMail.test(email1)){
				if(email1 == email2){
					divemail1.attr('class', 'form-group has-success has-feedback');
					inputemail1.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
					divemail2.attr('class', 'form-group has-success has-feedback');
					inputemail2.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
				}else{
					divemail1.attr('class', 'form-group has-success has-feedback');
					inputemail1.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
					divemail2.attr('class', 'form-group has-error has-feedback');
					inputemail2.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
					$("#confirmMail").tooltip({
						placement : 'auto-right',
						title : '<spring:message code="security.register.confirmmailerror" />'
					});
					error = true;
				}
			}else{
				divemail1.attr('class', 'form-group has-error has-feedback');
				inputemail1.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				divemail2.attr('class', 'form-group has-error has-feedback');
				inputemail2.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				$("#email").tooltip({
					placement : 'auto-right',
					title : '<spring:message code="security.register.emailerror" />'
				});
				error = true;
			}
			// Fallo en el pass
			if(pass1.length >= 5 && pass1.length <= 32){
				if(pass1 == pass2){
					divpass1.attr('class', 'form-group has-success has-feedback');
					inputpass1.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
					divpass2.attr('class', 'form-group has-success has-feedback');
					inputpass2.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
				}else{
					divpass1.attr('class', 'form-group has-success has-feedback');
					inputpass1.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
					divpass2.attr('class', 'form-group has-error has-feedback');
					inputpass2.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
					$("#confirmPass").tooltip({
						placement : 'auto-right',
						title : '<spring:message code="security.register.confirmpasserror" />'
					});
					error = true;
				}
			}else{
				divpass1.attr('class', 'form-group has-error has-feedback');
				inputpass1.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				divpass2.attr('class', 'form-group has-error has-feedback');
				inputpass2.attr('class', 'glyphicon glyphicon-remove form-control-feedback');
				$("#pass").tooltip({
					placement : 'auto-right',
					title : '<spring:message code="security.register.passerror" />'
				});
				error = true;
			}
			
			if(!error){
				$("#form1").hide("slide", {direction: "left"}, "slow", function(){
					$("#form2").show("slide", {direction: "right"}, "slow");
				});
			}
		});
	});
	...
	$(function(){
		$("#next2").click(function(){
			$("#form2").hide("slide", {direction: "left"}, "slow", function(){
				$("#form3").show("slide", {direction: "right"}, "slow");
			});
		});
	});
	...
	$(function(){
		$("#next3").click(function(){
			$("#form3").hide("slide", {direction: "left"}, "slow");
			$("#form4").show("slide", {direction: "right"}, "slow");
		});
	});	
	
	$(function(){
		$("#prev2").click(function(){
			$("#form2").hide("slide", {direction: "right"}, "slow", function(){
				$("#form1").show("slide", {direction: "left"}, "slow");
			});
		});
	});	
	...
	$(function(){
		$("#prev3").click(function(){
			$("#form3").hide("slide", {direction: "right"}, "slow", function(){
				$("#form2").show("slide", {direction: "left"}, "slow");
			});
		});
	});	
	...
	$(function(){
		$("#prev4").click(function(){
			$("#form4").hide("slide", {direction: "right"}, "slow", function(){
				$("#form3").show("slide", {direction: "left"}, "slow");
			});
		});
	});
	...
	$(function(){
		$("#check").click(function(){
			...
			var input = $("#div-username");
			var span = $("#span-username");
			if(username.length > 3){
				$.post("user/checkUsername.do?username="+username, function(result){
					if(result == 1){
						input.attr('class', 'form-group has-success has-feedback');
						span.attr('class', 'glyphicon glyphicon-ok form-control-feedback');
					}else{
						input.attr('class', 'form-group has-error has-feedback');
	...
	$(function () {
        $("#pass").complexify({}, function (valid, complexity) {
        	$("#progress");
        	$("#passComp").width(complexity+"%");
        	if(complexity < 25){
        		$("#passComp").attr('class', 'progress-bar progress-bar-danger');
        	}
        	if(complexity > 25 && complexity < 50){
        		$("#passComp").attr('class', 'progress-bar progress-bar-warning');
        	}
        	if(complexity > 50 && complexity < 75){
        		$("#passComp").attr('class', 'progress-bar progress-bar-info');
        	}
        	if(complexity > 75){
        		$("#passComp").attr('class', 'progress-bar progress-bar-success');
        	}
        });
    });
</script>

<form:form id="signUpForm" action="user/register.do" modelAttribute="signUpForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
	...
	<div id="form1">
		...
		<div class="form-left">
			<div id="div-username" class="form-group">
				<form:label path="username" class="col-sm-3 control-label signUpForm signUpForm"
					for="username">
					<spring:message code="security.register.username" /> (*) :
				</form:label>
				<div class="col-sm-5">
				...
				<div class="col-sm-4">
					<button type="button" class="btn btn-default" id="check">Check availability</button>
				</div>
			...
			<div id="div-name" class="form-group">
				...
				<form:label path="name" class="col-sm-3 control-label signUpForm" for="name">
					<spring:message code="security.register.name" /> (*) :
			</form:label>
				<div class="col-sm-5">
					<form:input class="form-control" type="text" id="name" name="name"
						path="name" />
			...
			<div id="div-surname" class="form-group">
				<form:label path="surname" class="col-sm-3 control-label signUpForm"
					for="surname">
			...
			<div id="div-birthdate" class="form-group">
				...
				<form:label path="birthDate" class="col-sm-3 control-label signUpForm"
					for="birthDate">
					<spring:message code="security.register.birthDate" /> (*) :
			</form:label>
				<div class="col-sm-5">
			...
			<div id="div-dni" class="form-group">
				<form:label path="dni" class="col-sm-3 control-label signUpForm" for="dni">
					<spring:message code="security.register.dni" /> (*) : 
			</form:label>
				<div class="col-sm-5">
					<form:input class="form-control" type="text" id="dni" name="dni"
						path="dni" maxlength="9" />
					<span id="span-dni"></span>
				</div>
		...
		<div class="form-right">
			<div id="div-email1" class="form-group">
				<form:label path="email1" class="col-sm-3 control-label signUpForm"
					for="email1">
					<spring:message code="security.register.email" /> (*) :
			</form:label>
				<div class="col-sm-5">
					<form:input class="form-control" id="email"
						name="email" path="email1" />
					<span id="span-email1"></span>
				</div>
			...
			<div id="div-email2" class="form-group">
				<form:label path="email2" class="col-sm-3 control-label signUpForm"
					for="email2">
					<spring:message code="security.register.confirmMail" /> (*) :
			</form:label>
				<div class="col-sm-5">
					<form:input class="form-control" id="confirmMail"
						name="confirmMail" path="email2" />
					<span id="span-email2"></span>
				</div>
				<form:errors cssClass="error" path="email2" />

				<br>
			</div>

			<div id="div-pass1" class="form-group">
				<form:label path="password1" class="col-sm-3 control-label signUpForm"
					for="password1">
					<spring:message code="security.register.pass" /> (*) :
				</form:label>
				<div class="col-sm-5" style="display:inline-block;">
					<form:input class="form-control" type="password" id="pass"
						name="pass" path="password1" />
					<span id="span-pass1"></span>
				</div>
				<div id="progress" class="progress">
					<div id="passComp" class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100">

					</div>
				</div>
				<form:errors cssClass="error" path="password1" />
			</div>
			<div id="div-pass2" class="form-group">
				<form:label path="password2" class="col-sm-3 control-label signUpForm"
					for="password2">
					<spring:message code="security.register.confirmPass" /> (*) :
			</form:label>
				<div class="col-sm-5">
					<form:input class="form-control" type="password" id="confirmPass"
						name="confirmPass" path="password2" />
					<span id="span-pass2"></span>
				</div>
		...
		<div class="modal-footer">
			<button id="next1" type="button" class="btn btn-primary" onclick="javascript:validarRegistro1();"><spring:message code="security.next" /></button>
		</div>
	</div>
	...
	<div id="form2" style="display:none;">
		...
		<div class="form-group">
			<img alt="No hay imagen" src="images/defecto.jpg"
				class="img-polaroid">
		</div>
		<br />
		<div class="form-group">
			<form:input path="fileData" type="file" class="form-control" />
		</div>
		<br />
		<div class="modal-footer">
			<button id="prev2" type="button" class="btn btn-primary"><spring:message code="security.prev" /></button>
			<button id="next2" type="button" class="btn btn-primary"><spring:message code="security.next" /></button>
		</div>
	</div>
	...
	<div id="form3" style="display:none;">
		...
		<div class="form-group">
			<form:label path="adress" class="col-sm-3 control-label signUpForm" for="adress">
				<spring:message code="security.register.adress" />:
				</form:label>

			<div class="col-md-8">
				<form:input class="form-control" type="text" id="adress"
					name="adress" path="adress" />
			</div>
			<form:errors cssClass="error" path="adress" />
		</div>
		<div class="form-group">
			<form:label path="city" class="col-sm-3 control-label signUpForm" for="city">
				<spring:message code="security.register.city" />:
			</form:label>
			<div class="col-sm-5">
				<form:input class="form-control" type="text" id="city" name="city"
					path="city" />
			</div>
			<form:errors cssClass="error" path="city" />
		</div>
		<div class="form-group">
			<form:label path="cp" class="col-sm-3 control-label signUpForm" for="cp">
				<spring:message code="security.register.cp" />:
			</form:label>
			<div class="col-sm-5">
				<form:input class="form-control" type="text" id="cp" name="cp"
					path="cp" />
			</div>
			<form:errors cssClass="error" path="cp" />
		</div>
		<div class="form-group">
			<form:label path="province" class="col-sm-3 control-label signUpForm"
				for="province">
				<spring:message code="security.register.province" />:
			</form:label>
			<div class="col-sm-5">
				<form:input class="form-control" type="text" id="province"
		...
		<div class="form-group">
			<form:label path="phone" class="col-sm-3 control-label signUpForm" for="phone">
				<spring:message code="security.register.phone" />:
			</form:label>
			<div class="col-sm-5">
				<form:input class="form-control" type="text" id="phone" name="phone"
					path="phone" />
			</div>
			<form:errors cssClass="error" path="phone" />
		</div>
		<div class="form-group">
			<form:label path="sex" class="col-sm-3 control-label signUpForm" for="sex">
				<spring:message code="security.register.sex" />:
			</form:label>
			<div class="col-sm-7">
				<form:select class="form-control" path="sex"
					...
					<form:option value="0">
						<spring:message code="security.register.male" />
					</form:option>
					<form:option value="1">
						<spring:message code="security.register.female" />
					</form:option>
				</form:select>
			</div>
		...
		<div class="modal-footer">
			<button id="prev3" type="button" class="btn btn-primary"><spring:message code="security.prev" /></button>
			<button id="next3" type="button" class="btn btn-primary"><spring:message code="security.next" /></button>
		</div>
	</div>
	...
	<div id="form4" style="display:none;">
		...
		<div class="form-group">
			<div class="center">
			<form:checkbox id="checkbox" name="checkbox" path="userTerms" />
			<spring:message code="security.register.userTerms" />
			<form:errors cssClass="error" path="userTerms" />
...
Puede ponerse en contacto con Bet-me por correo postal enviado a las direcciones indicadas en la cláusula 2.1.; por correo electrónico a través de la sección de Contáctenos; o por teléfono."
			</textarea>
			</div>
		</div>
		<div class="modal-footer">
			<button id="prev4" type="button" class="btn btn-primary"><spring:message code="security.prev" /></button>
			<button type="submit" class="btn btn-primary"><spring:message code="master.page.register" /></button>
		</div>
	</div>
</form:form>