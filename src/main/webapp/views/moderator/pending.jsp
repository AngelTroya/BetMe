...
<jstl:if test="${accepted == true}">
		<div class="alert alert-success">
			<button type="button" class="close" data-dismiss="alert">&times;</button>
			<spring:message code="moderator.accepted.ok" />
		</div>
</jstl:if>

<jstl:if test="${accepted == false}">
		<div class="alert alert-danger">
			<button type="button" class="close" data-dismiss="alert">&times;</button>
			<spring:message code="moderator.accepted.error" />
		</div>
</jstl:if>
...
<display:table name="bets" pagesize="10" class="table" requestURI="${requestURI}" id="row">
	...
	<display:column sortable="false">
		<a href="moderator/detailsPending.do?betId=${row.id}" >
			${details}
		</a>
	</display:column>
	...
	<display:column sortable="false">
		<a href="moderator/accept3.do?betId=${row.id}" >
			${action}
		</a>
	</display:column>
	...
	<display:column sortable="false">
		<a href="moderator/reject3.do?betId=${row.id}" >
			${action}
		</a>
	</display:column>
