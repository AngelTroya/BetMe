...
<%@page import="domain.Bet" %>

<!-- Listing grid -->

<jstl:if test="${deleteComment == true}">
		<div class="alert alert-success">
			<button type="button" class="close" data-dismiss="alert">&times;</button>
			<spring:message code="moderator.deleteComment.ok" />
		</div>
</jstl:if>

<jstl:if test="${deleteComment == false}">
		<div class="alert alert-danger">
			<button type="button" class="close" data-dismiss="alert">&times;</button>
			<spring:message code="moderator.deleteComment.error" />
		</div>
</jstl:if>
...
<a href="moderator/proposed.do">
	<spring:message code="moderator.proposed" />
</a>
